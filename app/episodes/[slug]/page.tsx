                        ...
                        <div className="flex flex-col sm:flex-row gap-6 relative z-50 mt-4 md:mt-0">
                            <details className="group relative list-none [&::-webkit-details-marker]:hidden cursor-pointer">
                                ...
                                <div className="absolute left-0 mt-3 w-64 bg-zinc-900 border border-zinc-700/50 rounded-xl shadow-2xl overflow-hidden z-50 flex flex-col pointer-events-auto">
                                    <a href={episode.spotifyLink || "https://open.spotify.com/show/5LPGObcWQdkoERNzZsdL98"} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 hover:bg-zinc-800 transition-colors text-zinc-200 border-b border-zinc-800/50 group/link">
                                    ...
                                    <a href={episode.appleLink || "https://podcasts.apple.com/us/podcast/syntinuum-endless-evolutions/id1729494958"} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 hover:bg-zinc-800 transition-colors text-zinc-200 border-b border-zinc-800/50 group/link">
                                    ...
                                    <a href={episode.youtubeLink || "https://www.youtube.com/channel/UCg2BeZarXY7YLdnFYwRS_HQ"} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 hover:bg-zinc-800 transition-colors text-zinc-200 border-b border-zinc-800/50 group/link">
                                    ...
                                    <a href={episode.amazonLink || "https://music.amazon.com/podcasts/a9b7e115-185a-4324-ae2d-33488a4fd26c/syntinuum-endless-evolutions"} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 hover:bg-zinc-800 transition-colors text-zinc-200 border-b border-zinc-800/50 group/link">
                                    ...
                                    <a href={episode.castboxLink || "https://castbox.fm/channel/Syntinuum%3A-Endless-Evolutions-id6033032?country=us"} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-4 py-3 hover:bg-zinc-800 transition-colors text-zinc-200 group/link">
