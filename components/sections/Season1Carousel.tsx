                    ...
                    {episodes.map((ep, i) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <Link href={`/episodes/${ep.id}`} className="block w-full text-center py-2 rounded-lg border border-zinc-700 hover:bg-white hover:text-black hover:border-white transition-all text-xs font-mono font-bold tracking-widest uppercase mt-auto">
                                    View Episode
                                </Link>
                            </div>
                        </motion.div>
